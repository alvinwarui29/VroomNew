							...
							<div class="border border-3 p-4 rounded">
								<div class="row g-3">
									...
									<div class="col-md-6">
										...
										<input type="text" name="discount_price" class="form-control" id="inputCompareatprice" placeholder="{{$product->discount_price}}">
									</div>
									<div class="form-group col-md-6">
									...
									<div class="form-group col-md-6">
										...
										<input type="text" name="product_qty" class="form-control" id="inputStarPoints" placeholder="{{$product->product_qty}}">
									</div>
									...
									<div class="col-12">
										<div class="d-grid">
											<input type="submit" id="myForm" class="btn btn-primary px-4" value="Update Changes" />
