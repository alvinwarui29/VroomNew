                                        ...
                                        <form method="post" action="{{ route('user.profile.store') }}" enctype="multipart/form-data">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <img id="showImage" src="{{ (!empty($userData->photo)) ? url('uploads/user_images/'.$userData->photo):url('uploads/no_image.jpg') }}" alt="User" class="rounded-circle p-1 bg-primary" width="110">
                                                </div>
