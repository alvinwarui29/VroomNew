                    ...
                    <div class="header-action-right">
						...
						" class="user-img" alt="user avatar">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                    <li><a class="dropdown-item" href="{{route('user.profile.setup')}}"><i class="bx bx-user"></i><span>Profile</span></a>
                                    </li>
                            ...
                            <ul>
                                ...
                                <li>
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        <li><a href="{{route('view.tour.by.agency',$agency->id)}}">{{$agency->name}}</a></li>
                                        @endforeach
                                    </ul>
                                </li>
